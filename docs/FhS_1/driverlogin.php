...
<div>
		<div class="wrap-content container" style="width: 500px;">
			<section id="page-title">
				<div>
					<h1 class="mainTitle" style="text-align: center;">تسجيل الدخول</h1><h2 style="text-align: right;"></h2>
				</div>
			</section>
			<div>
				<div class="row">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<form action="" method="post">
											...
											<input type="submit" name="submit" value="تسجيل الدخول" class="btn btn-o btn-primary"><h6 style="text-align: center;"><a   href="driverreg.php">New user</a></h6>
